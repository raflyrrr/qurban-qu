		...
		<div class="row">
			<div class="col-md-8 col-sm-6">
				...
				<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" id="register">
					...
					<div class="form-group">
						<label>Alamat :</label>
						<textarea class="form-control" name="alamat_lengkap" id="alamat_lengkap" rows="5" placeholder="Masukan alamat lengkap."><?php echo $alamat_lengkap; ?></textarea>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="username" id="username" placeholder="Masukan username." minlength="5" value="<?php echo $username; ?>" />
					</div>
