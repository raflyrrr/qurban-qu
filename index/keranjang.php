...
<div class="row mt-5">      
			...
			<div class="table-responsive">
				<table width="100%"" class="table table-sthiped">
					...
					<tr>
						...
						<td><b>Rp. ' . number_format($jumlah_beli * $harga_produk + ($hargapotongkr * $jumlah_beli )) . '</b></td>
					</tr>
	...
	<div class="col-md-6 col-sm-6">
			...
			<ol>
			<li>Bank BCA : 123123 atas nama <b>QurbanQu</b></li>
			<li>Bank Mandiri : 123123 atas nama <b>QurbanQu</b></li>
			</ol>
...
';
	...
	<div class="table-responsive mt-5">
		<table width="100%"" class="table table-sthiped">
			...
			<tr>
				<td>Harga</td>
				<td>' . number_format($harga_produk) . '</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>' . 'Rp. ' . number_format($hargapotongkr * $jumlah_beli) . '</td>
			</tr>
			<tr>
