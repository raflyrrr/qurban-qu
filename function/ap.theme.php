    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      <div class="container">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="funfact.php">Fun Fact
            </a>
          </li>
        </ul>
      </div>
  ...
  echo '
   ...
   <!-- Footer -->
    ...
    <footer class="py-5 footer-bg">
      ...
      <div class="container">
        <p class="m-0 text-center text-white">Contact Me : <i class="fab fa-whatsapp"></i><a href="https://api.whatsapp.com/send?phone=6281297094135&text=Halo%20QurbanQu%2C%20saya%20ingin%20bertanya%20tentang%20%3A%20" class="m-0 text-center text-white" target="_blank"> +62 812-9709-4135</a></p>
      </div>
      <!-- /.container -->
    </footer>
...
function LoadHeadPanel()
{
  ...
  <html lang="id">
    ...
    <title>Admin Panel - QurbanQu</title>
  ';
}
...
function LoadMenuPanel()
{
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-light static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">QurbanQu</a>
      ...
      <ul class="sidebar navbar-nav">      
       ...
       <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="produk.php">Semua Hewan</a>
            <a class="dropdown-item" href="produk.php?produk=kategori">Jenis Hewan</a>
            <a class="dropdown-item" href="produk.tambah.php">Tambah Hewan</a>
       ...
       <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="lihatFunfact.php">Semua Fun Fact</a>
            <a class="dropdown-item" href="tambahFunfact.php">Tambah Fun Fact</a>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; '.date("Y").'  QurbanQu</span>
            </div>
          </div>
        </footer>
