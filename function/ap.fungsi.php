...
function LoadProduk()
{
	...
	*/
	...
	echo '
		...
		<h4 style="margin-bottom:20px;">Hewan qurban terbaru</h4>
		<div class="row mb-3">
	...
	if ($ProdukTampil->num_rows > 0) {
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mb-3" data-aos="fade-up">
          ...
          <div class="card-body">
           ...
           <div class="post-info">
           <span class="produk-info"><i class="fas fa-fw fa-bookmark"></i>' . $row['jenis_produk'] . '</span>
           <span class="label-info float-right">' . number_format($row['satuan_produk']) . ' kg</span>
           </div>
            <p class="card-text">
            ';
        ...
        <div class="col-md-6 col-sm-6">
        	<h1 style="font-size:24px;">' . $nama_produk . '</h1>
        	   <ul class="nav nav-tabs" role="tablist">
			    <li class="nav-item">
			      <a class="nav-link active" data-toggle="tab" href="#home" style="color:#C68B59;">Deskripsi Hewan</a>
			    </li>		    
				<li class="nav-item">
			      <a class="nav-link" data-toggle="tab" href="#menu1"style="color:#C68B59;">Beli</a>
			    </li>	
			  </ul>
			
			<div class="tab-content">
				<div id="home" class="container tab-pane active"><br>
				<p align="justify">'.htmlspecialchars_decode($deskripsi_produk).'</p>
				</div>
...
function InsertKeranjang($data1, $data2, $data3, $data4, $data5, $data6, $data7, $data8, $data10, $data11, $data12,$data13,$data14)
{
	$sql = "INSERT INTO ap_keranjang (id_pembeli, nama_pembeli, alamat_pembeli, jumlah_beli, id_produk, nama_produk, jenis_produk, harga_produk, satuan_produk, foto_produk, tanggal_pembelian,potong,hargapotongkr) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
	if ($stmt = prepare($sql)) {
		$stmt->bind_param(
			"isssisssssssi",
			$param_data1,
