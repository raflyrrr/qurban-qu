...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($koneksi, "insert into ap_funfact(judul,deskripsi,fotofunfact) values('$judul','$deskripsi','$fotofunfact')");
    $_SESSION['msg'] = "menambah Fun Fact";
}
?>
<div id="content-wrapper">
    <div class="container-fluid">
        <ol class="breadcrumb" style="margin-top: 15px;">
            ...
            <li class="breadcrumb-item active">Tambah Fun Fact</li>
        </ol>
        <?php if (isset($_POST['submit'])) {
            header("refresh:1; url=lihatFunfact.php");
        ?>
        ...
        <div class="form-group">
            ...
            <textarea name="deskripsi" class="form-control" required="" rows="5"></textarea>
        </div>
        <div class="form-group">
            <label>Foto </label>
