...
if(isset($_POST["detail_order"])){
 ...
 echo "<div class='table-responsive'>";  
      echo "<table width='100%' class='table table-bordered'>";  
                ...
                echo "</tr>";
                echo "<tr>";  
                echo "<td>Nama Hewan</td>";  
                echo  "<td>".$nama_produk."</td>";  
                echo "</tr>";
                echo "<tr>";  
                echo "<td>Jenis Hewan</td>";  
                echo  "<td>".$jenis_produk."</td>";  
                echo "</tr>";
                echo "<tr>";  
                echo "<td>Harga</td>";  
                echo  "<td>"."Rp. ".number_format($harga_produk)."</td>";  
                echo "</tr>";
                echo "<tr>";  
                echo "<td>Potong Ditempat</td>";  
                echo  "<td>".$potong."</td>";  
                echo "</tr>";
                echo "<tr>";  
                echo "<tr>";  
                echo "<td>Harga Potong</td>";  
                echo  "<td>".number_format($hargapotongkr * $jumlah_beli)."</td>";  
                echo "</tr>";
                echo "<tr>";  
                ...
                echo  "<td><b>".number_format($harga_produk * $jumlah_beli + ($hargapotongkr* $jumlah_beli))."<b></td>";  
                echo "</tr>";
