...
?>
<?php
$simpan = $nama_produk_err = $deskripsi_produk_err = $satuan_produk_err = $jenis_produk_err = $harga_produk_err = $stok_produk_err = $hargapotong_err= $foto_produk_err = "";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (empty($nama_produk_err) && empty($deskripsi_produk_err) && empty($jenis_produk_err) && empty($harga_produk_err) && empty($satuan_produk_err) && empty($stok_produk_err)&&empty($hargapotong_err) &&  empty($foto_produk_err)) {
    ...
    if (UpdateProduk($nama, $nama_produk, $deskripsi_produk, $jenis_produk, $harga_produk, $satuan_produk, $stok_produk,$hargapotong, $foto_produk, $id)) {
...
<div id="content-wrapper">
  <div class="container-fluid">
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" name="harga_produk" required="" value="<?php echo $harga_produk; ?>" />
    ...
    <div class="form-group">
      <label>Berat</label>
      <input type="number" class="form-control" name="satuan_produk" required="" value="<?php echo $satuan_produk; ?>" />
      <span style="color: red;"><?php echo $satuan_produk_err; ?></span>
    </div>
    <div class="form-group">
      <label>Stok</label>
      <input type="number" class="form-control" name="stok_produk" required="" value="<?php echo $stok_produk; ?>" />
