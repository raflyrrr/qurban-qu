	...
	if($_GET['produk']=='detail'){
		if(!empty(trim($_GET['id'])) || intval($_GET['id'])){
			...
			echo "<meta http-equiv=\"refresh\"content=\";URL=home\"/>";
				...
				LoadProdukContent($id, $nama_produk_pemilik, $nama_produk, $deskripsi_produk, $jenis_produk, $harga_produk, $satuan_produk, $stok_produk,$hargapotong, $foto_produk, $tanggal_buat, $tanggal_update);
